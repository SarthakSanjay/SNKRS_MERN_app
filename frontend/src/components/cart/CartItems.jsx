  ...
  return (
    <div className='bg-gray-800 h-[100px] w-[500px] flex justify-between items-center m-5 '>
        ...
        <div className='bg-red-400 w-[120px] rounded-[5px] flex justify-between p-2'>
            <button onClick={increment} className='bg-gray-500 border-[1px] border-black rounded-[2px]'>
                <AiOutlineArrowUp />
            </button>
            Qty : {quantity}
            <button onClick={decrement} className='bg-gray-500 border-[1px] border-black rounded-[2px]'>
                <AiOutlineArrowDown />
            </button>
        </div>
        </div>
